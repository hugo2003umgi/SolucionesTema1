...
date:  "16-02-24"  #Pondría la fecha del día actual
params:
  lang: ES
...
# Visión del conjunto mammals
dim(mammals)
head(mammals)
tail(mammals)
str(mammals)

# Visión del conjunto Animals2
dim(Animals2)
head(Animals2)
tail(Animals2)
str(Animals2)
...
```{r}
mammals["Arctic fox",]
Animals2["Artic ground squirrel",]
...
#Presentan prácticamente el mismo comportamiento, y podríamos decir que siguen una distribución gaussiana.
